...
class MasterRecord(dict):
    ...
    def save(self, mst, encoding='', reset_flags=False):
        ...
        #save new field to last position
#        fields = []
#        last_fields = []
#        if self.last_insert_key:
#            for field in self.get_fields():
#                if field.tag in self.last_insert_key:
...
#        else:
        ...
        if test_pos >= 497 and test_pos <= 511:
    ...
    def _read_leader(self, mst):
        ...
        self.mfn, mfrl, self.mfbwb, self.mfbwp, base, nvf, \
